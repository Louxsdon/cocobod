                            ...
                            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                                ...
                                <blockquote className="relative p-8 mb-4">
                                    ...
                                    <p className="text-md font-light mt-2 text-white">
                                        ...
                                        presentation to login areas, you can
                                        easily customise and built your pages.
                                    </p>
                                </blockquote>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap items-center pt-32">
                        ...
                        <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
                            ...
                            <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                                ...
                                components require JavaScript. In this way you
                                can manipulate the elements on the page and give
                                more options to your users.
                            </p>
                            <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                                We created a set of Components that are dynamic
                        ...
                        <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
                            <div className="md:pr-12">
                                ...
                                <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                                    ...
                                    examples that help you get started faster.
                                    You can adjust the colors and also the
                                    programming language. You can change the
                ...
                <div className="justify-center text-center flex flex-wrap mt-24">
                    <div className="w-full md:w-6/12 px-12 md:px-4">
                        ...
                        <p className="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
                            Notus React is a completly new product built using
                            our past experience in web templates. Take the
                            examples we made for you and start playing with
                            them.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap justify-center bg-white shadow-xl rounded-lg -mt-64 py-16 px-12 relative z-10">
                        <div className="w-full text-center lg:w-8/12">
                            ...
                            <p className="text-blueGray-500 text-lg leading-relaxed mt-4 mb-4">
                                ...
                                buttons below to navigate to get the Free
                                version for your next project. Build a new web
